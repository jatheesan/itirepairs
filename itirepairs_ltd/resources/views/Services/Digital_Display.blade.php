        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-6 px-5 pb-30 md-pb-0 xs-30 zero-padding">
                    <h3 class="line txt-blue">Outdoor LED advertising screens</h3>
                    <img src="{{ asset('images/s-screen/screen1.jpg')}}" class="d-lg-none img-show image-3db" alt="itirepaire">
                ...
                <div class="col-lg-6 px-5 pt-30 md-pt-0 sm-pt-30 zero-padding">
                    <h3 class="line txt-blue">Indoor LED Advertising Screens</h3>
                    <img src="{{ asset('images/s-screen/screen3.jpg')}}" class="d-lg-none img-show image-3da" alt="itirepaire">
                    <ul class="listing-style li-bold">
                        <li>
                ...
                <div class="col-lg-6 px-5 pb-30 md-pt-0 sm-pt-30 md-pb-0 xs-30 zero-padding">
                    <h3 class="line txt-blue">LED Video Wall</h3>
                    <img src="{{ asset('images/s-screen/screen2.jpg')}}" class="d-lg-none img-show image-3db" alt="itirepaire">
                    <ul class="listing-style li-bold">
                        <li>
